...
"i586-linux-thread-multi-2.6.32-5-686" or
	die "Errno architecture (i586-linux-thread-multi-2.6.32-5-686) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
